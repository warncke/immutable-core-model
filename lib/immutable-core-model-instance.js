...
function action (name, args) {
    ...
    var allow = model.accessControl.allowModel({
        accessId: this[model.model.accessIdName],
        action: name,
...
function init (args) {
    ...
    if (!args.allow && !this.model.isAction) {
        ...
        // get access id
        var accessId = this[accessIdName] || this.data && this.data[accessIdName]
        // if accessId not set then set scope to any
        var scope = accessId ? undefined : 'any'
        // check access
...
function updateMeta (args) {
    ...
    var accessIdName = this.model.accessIdName
    // get access id of record
    var accessId = this[accessIdName] || this.data[accessIdName]
