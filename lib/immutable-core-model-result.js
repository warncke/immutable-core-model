...
function fetch (fetchNum) {
    ...
    // if the isDeleted property is set on query this pass to record query
    if (query && query.where && query.where.isDeleted !== undefined) {
        whereArgs.isDeleted = query.where.isDeleted
    }
    // fetch records
