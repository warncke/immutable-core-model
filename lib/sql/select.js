...
function buildWhereRelationDirect (name, value, relation) {
    ...
    // build sql
    var whereSql = `${this.alias}.${this.quoteName(relation.modelIdColumn)} = UNHEX(:${paramName})`
    // add value to params
...
function buildWhereRelationVia (name, value, relation) {
    ...
    // build sql
    var whereSql = `${viaAlias}.${this.quoteName(relation.viaRelationIdColumn)} = UNHEX(:${paramName})`
    // add value to params
